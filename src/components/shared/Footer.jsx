            ...
            <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                ...
                <div className="border-t border-zinc-900 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <p className="text-xs text-zinc-500 font-normal">
                        &copy; {new Date().getFullYear()} Fable Books Inc. All rights reserved.
                    </p>
                    <div className="flex gap-4">
                        <a href="https://facebook.com" className="text-zinc-500 hover:text-amber-400 transition-colors" aria-label="Facebook link">
                        ...
                        <a href="https://x.com" className="text-zinc-500 hover:text-amber-400 transition-colors" aria-label="Twitter link">
                        ...
                        <a href="https://linkedin.com" className="text-zinc-500 hover:text-amber-400 transition-colors" aria-label="LinkedIn link">
